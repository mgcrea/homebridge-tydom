export default {
  ...
  ACTIVE_ALERTS_INTRUSION:
    "When you activate this function, your alarm system alerts you about any intruders detected",
  ...
  ALERT_TYCAM_NO_CALL_WITH_NUMBER_ANDROID_TEXT:
    "Cannot call with this device. Dial %s on your phone for assistance",
  ALLEY: "Alley",
  ...
  CG_DD_DISPLAY_RAD:
    "The screen displays “rAd“ and the number of devices already associated.\nNow press “ASSOCIATE“",
  ...
  INTRUSION_DETECTION_NOTIFICATION_MESSAGE:
    "You will receive a notification each time an intruder is detected",
  ...
  PROG_MOMENT_ACTIONS_EXPLICATION:
    "Define the action to take for the devices selected at the start time of the moment",
  ...
  PROG_MOMENT_POPUP_TOTAL_LIMIT_MESSAGE:
    "You have reached the maximum number of 48 moments in your programming",
  ...
  SETTINGS_SCENARIOS_SET_ACTIONS_TEXT:
    "Set actions for each device that will be affected upon launching the scenario",
  ...
  SETTINGS_SITE_REPLACE_RESET_ALERT:
    "The new TYDOM box will be reset to zero, and all information will be deleted",
