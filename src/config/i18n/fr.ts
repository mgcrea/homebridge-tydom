export default {
  ...
  CG_DD_CAMERA_ETH_STEP2:
    "Connectez la caméra à votre box ADSL via un câble RJ45. \nPuis appuyez sur CONTINUER.",
  CG_DD_CAMERA_WPS_STEP1:
    "Appuyez sur le bouton WPS de votre box ADSL et de la caméra. \nPuis appuyez sur CONTINUER.",
  ...
  CG_DD_END_OFF_BIP:
    "Une fois l'équipement associé, appuyez sur la touche OFF.\nLa centrale confirme par un BIP.",
  ...
  CG_DD_PRESS_BUTTON_OK_STEP:
    "Appuyez successivement sur la touche OK pour sélectionner l'écran de l'étape suivante.",
  CG_DD_PRESS_BUTTON_ONE_OR_ALL:
    "Appuyez 3 secondes sur la touche du ou des récepteurs.\nLa LED rouge clignote.",
  ...
  MIGRATION_FAILED_MESSAGE:
    "Votre migration s’est mal passée, vous risquez de ne pas retrouver votre installation.",
  MIGRATION_TEXT:
  ...
  PROG_MOMENT_EQUIPMENTS_EXPLICATION:
    "Sélectionnez les équipements que vous souhaitez activer lors de ce moment.",
  ...
  PROG_MOMENT_POPUP_TOTAL_LIMIT_MESSAGE:
    "Vous avez atteint le nombre maximum de 48 moments dans votre programmation.",
  ...
  SETTINGS_SITE_FORGOT_PASSWORD_TEXT:
    "Le mot de passe TYDOM vous sera demandé lors de votre prochaine connexion.",
  ...
  SETTINGS_SITE_UPDATE_OLD_ERROR_PASSWORD_TEXT:
    "L'ancien mot de passe saisi est incorrect, veuillez réessayer",
  SETTINGS_SITE_UPDATE_OLD_ERROR_PASSWORD_TITLE: "Ancien mot de passe incorrect",
  SETTINGS_SITE_UPDATE_PASSWORD_TEXT:
    "Pour vous connecter au TYDOM, utilisez désormais le nouveau mot de passe saisi.",
  ...
  SITE_ADD_TEXT:
    "Pour commencer, appuyez sur Nouveau Domicile pour vous connecter à votre box domotique TYDOM.",
